package com.example.demo.date.api;
...
public class LocalDateTimeApi {
    ...
    public static void actual() {
        ...
        //获取此日期时间的时间顺序
        //java.time.LocalDate.getChronology()方法获取此日期的时间顺序，即ISO日历系统。
    ...
    public static void build(){
        LocalDateTime.of(2020,6,1,12,12);
        LocalDateTime.of(2020,6,1,12,12,12);
        LocalDateTime.of(2020,6,1,12,12,12,12);
        LocalDateTime.of(2020,Month.JANUARY,1,1,1);
        LocalDateTime.of(2020,Month.JANUARY,1,1,1,1);
        LocalDateTime.of(2020,Month.JANUARY,1,1,1,1,0);
