...
public class Functions {
    ...
    /**
     * add 100 Function Interfaces
     */
    public Long plusOneHundredFunction(Long apply) {
        Function<Long, Long> plusFunction = new Function<Long, Long>() {
            @Override
        ...
        Long apply1 = plusFunction.apply(10L);
        return apply1;
    }

    /**
     * 行为参数化：此例传入的Function是将每一个goods转为名称的String
     *
     * @param function
     */
